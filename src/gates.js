...
GATES.snow = {
  ...
  // ── ทำไมหางยาวกว่าทางเข้าอื่นมาก ──
  // จังหวะที่ภาพของทางเข้าส่งต่อให้ด่าน เป็นจุดที่พื้นเปลี่ยนมือ และไม่ว่าจะจูนให้ตรงแค่ไหน
  // ตาก็ยังจับได้ (ผู้เล่นรายงานซ้ำหลายรอบ) ทางแก้คือ "บังมันเสีย" —
  // ให้พายุซัดหิมะลงมากองทับพื้นตรงนั้นสักพัก แล้วค่อยละลายเผยพื้นของด่านออกมา
  // กองหิมะต้องอยู่ต่อหลังพ้นตัวพายุไปแล้วราว 1460px ทางเข้าจึงต้องมีชีวิตอยู่นานกว่านั้น
  artTail: 1560,
