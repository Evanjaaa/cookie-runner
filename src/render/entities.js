...
function drawBall(ctx, h, x, pal) {
  ...
  // ลูกที่โดนเตะกระเด็นไม่มีเงา: ตอนนั้นผู้เรียกวาดจากระบบพิกัดที่หมุนตามลูกบอล (ดู drawHazards)
  // เงาที่ตรึงไว้ที่ GROUND_Y จึงหมุนเด้งตามไปด้วย กลายเป็นเงาลอยเด้งอยู่กลางอากาศข้างตัวแมว
  // และถึงจะแก้พิกัดให้ถูก ลูกที่ปลิวอยู่กลางอากาศก็ไม่ควรมีเงาทาบพื้นอยู่แล้ว
  if (!h.smashed) {
 ...
 */
/**
 * สวิตช์แสงเรือง — ปิดชั่วคราวตอนวาด "เงาทึบ" สำหรับเส้นขอบ (ดู render/outline.js)
 * แสงเรืองเป็นวงโปร่งกว้าง ถ้าหลุดเข้าไปในเงา จะได้คราบเทาดำทั้งวงแทนที่จะเป็นเส้นรอบตัวของ
 */
export const GLOW = { on: true };
